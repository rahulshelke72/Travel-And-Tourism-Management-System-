...
public class CheckHotel extends JFrame implements Runnable{
    ...
    public void run(){
        ...
        String[] text=new String[]{"JW Marriot Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radisson Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","Quick Stop Hotel","Happy Mornings Hotel","Moss View Hotel"};
    ...
    CheckHotel(){
        ...
        caption.setBounds(40,400,400,40);
        add(caption);
